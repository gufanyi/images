    ...
    <form method="" action="warning/saveWarning.shtml" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
        ...
        <div class="pageFormContent" layoutH="56">
            <p>
                ...
                <input type="text" id="ips" class="required" value="${wdIpAddr}" ${empty wdIpAddr?"suggestUrl='warning/selectIp.shtml'": "readonly='true' style='border:0'"} name="ips"     suggestFields="ips"/>
