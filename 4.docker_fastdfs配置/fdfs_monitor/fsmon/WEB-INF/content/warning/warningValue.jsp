...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="add" href="warning/warningEdit.shtml" target="dialog" rel="warningEdit"><span>添加</span></a></li>
...
<c:forEach items="${warningValues}" var="wvs">
    <tr target="wid" rel="${wvs.id}">
       <td><input name="ids"  class="checkboxCtrl" value="${wvs.id}" type="checkbox"></td>
        ...
        <td>
           <a title="删除" target="ajaxTodo" href="warning/delWarning.shtml?ids=${wvs.id}" class="btnDel">删除</a>
