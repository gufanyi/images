...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="warning/warUserAdd.shtml" target="dialog" rel="warUserAdd"><span>添加</span></a></li>
    ...
    <table class="table" width="1200" layoutH="138">
        ...
        <c:forEach items="${warUserLists}" var="wul">
            <tr target="wid" rel="${wul.id}">
                ...
                <td>${wul.email}</td>
                <td>
                    <a title="删除" target="ajaxTodo" href="warning/delWarUser.shtml?ids=${wul.id}" class="btnDel">删除</a>
