...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="user/useradd.shtml" target="dialog" rel="useradd"><span>添加</span></a></li>
    ...
    <table class="table" width="1200" layoutH="138">
        ...
        <c:forEach items="${userlist}" var="user">
            <tr target="wid" rel="${user.id}">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="user/deluser.shtml?ids=${user.id}" class="btnDel">删除</a>
