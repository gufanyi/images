...
<table id="graphContainer">
	<tr>
		<td style="width: 40%;"><c:forEach items="${groupInfo}"
				var="group">
								...
								<tr>
									<td style="width: 50%">
										<div id="${group.groupName}${status.index}" class="storage"
											...
											<a href=" javascript:;"
												...
												<img src="${basePath}/images/storage.png"
												alt="${storage.ipAddr}">
											</a>
									...
									<td width="80%">
										<table width="200px;" border="2" style="border-color: white;">
											<tr>
												<td colspan="2"
													style="text-align: center; font-size: 15px; font-weight: 500">服务器相关参数</td>
											</tr>
											<tr>
		...
		<td style="width: 20%"><img src="${basePath}/images/line.png"
			width="100%"></td>
		<td style="width: 40%">
			<div class="panel" defH="200">
				<h1>TRACKER</h1>
					<table>
				<c:forEach items="${trucker}" var="inner">
				<tr>
				     <td style="width: 50%">
					<div class="panelContent" >
						<a href=" javascript:;"
							onclick="navTab.openTab('serverInfo','structure/serverInfo.shtml?ip=${inner.ip}',{title:'服务器详细信息'})">
							<img src="${basePath}/images/track.png" alt="${inner.ip}${inner.port}"style="float: left; margin-right: 350px" />
						</a> 
						
						<span style="font-weight: 800; color: red">${inner.ip}${inner.port}</span>
					</div>
					</td>
					</tr>
				</c:forEach>
